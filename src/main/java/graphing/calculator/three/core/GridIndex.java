...
public class GridIndex {
     ...
     * whole index with the enlarged region.
     *
     * @param updatedTriangles changed triangles of the triangulation. This may
     * be added triangles, removed triangles or both. All that matter is that
    ...
    private Triangle findValidTriangle(PointInt minInvalidCell) {
        ...
        } else // Otherwise we can take an adjacent cell triangle that is still
        // valid
        {
     ...
     *
     * @param xIndex horizontal cell index
     * @param yIndex vertical cell index
